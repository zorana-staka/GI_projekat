...
class Output_file:
    ...
    def read_input_files(self):
        for input_file in self.list_of_input_files:
            ...
            self.list_of_header_objects += input_file.list_of_header_objects
            self.list_of_body_objects += input_file.list_of_body_objects
    ...
    def filter_header_lines(self):
        self.list_of_header_lines = sorted(set(self.list_of_header_lines))

    # izbacititi duplikate
    def filter_body_lines(self):
        self.list_of_body_lines = sorted(set(self.list_of_body_lines))

    def arrange_header(self):
        #self.list_of_header_objects = sorted(set(self.list_of_header_objects))
        self.list_of_header_objects.sort(key=lambda x: x.line)

    def arrange_body(self):
        #self.list_of_body_objects = sorted(set(self.list_of_body_objects))
